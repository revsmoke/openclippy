...
export const GRANTED_SCOPES_PATH = join(STATE_DIR, "granted-scopes.json");
export const MEMORY_DB_PATH = join(STATE_DIR, "memory.db");
export const TRIAGE_DIR = join(STATE_DIR, "triage");
export const TRIAGE_RULES_PATH = join(TRIAGE_DIR, "rules.yaml");
export const TRIAGE_DB_PATH = join(STATE_DIR, "triage.db");
